...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.id_rcv_data1);
    ...
    public void loadData(View view){
        if (isOnLine()){
            ...
            TaskPosts taskPosts = new TaskPosts();
            taskPosts.execute("https://jsonplaceholder.typicode.com/posts");
        }else {
    ...
    public class TaskPosts extends AsyncTask<String, String, String> {
        @Override
